    ...
    <div role="main" class="cover  mb-5">
        ...
        <div class="row mt-5">
            <div class="col-12 col-md-3 pt-3">
                <a href="{{route('admin.allUser')}}" class="btn btn-lg btn-secondary form-control">See all Users</a>
            </div>
            <div class="col-12 col-md-3 pt-3">
                <a href="{{route('admin.createuser')}}" class="btn btn-lg btn-secondary form-control" > Create User </a>
            </div>
            <div class="col-12 col-md-3 pt-3">
                <a href="{{ route('admin.classes') }}" class="btn btn-lg btn-secondary form-control">Show All Classes</a>
            </div>
            <div class="col-12 col-md-3 pt-3">
                <a href="{{ route('information') }}" class="btn btn-lg btn-secondary form-control">Create Information</a>
            </div>
        </div>
